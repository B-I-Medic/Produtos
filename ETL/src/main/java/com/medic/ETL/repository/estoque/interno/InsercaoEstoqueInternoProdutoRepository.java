...
@Repository
public class InsercaoEstoqueInternoProdutoRepository {

    private final JdbcTemplate jdbcTemplate;

    public InsercaoEstoqueInternoProdutoRepository(@Qualifier("pgJdbcTemplate") JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void inserirEmLote(List<EstoqueInterno> itens) {
        ...
        jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int index) throws SQLException {
                ...
                EstoqueInterno item = itens.get(index);
